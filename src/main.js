...
function cardFiller(songsNames, songsPaths, songsImages) {
  const songsContainer = Array.from(
    document.querySelectorAll(".cardContainer"),
  );

  songsContainer.forEach((song, index) => {
    song.innerHTML = `
                <div
                  class="songCard relative mb-[13px] flex w-[100%] items-center justify-between rounded-md p-[7px] hover:bg-[#1d1d1d] md:mb-[13px]"
                >
                  ...
                  <div
                    class="iconsContainer hidden w-[25%] justify-center md:justify-around"
                  >
                    <button
                      type="button"
                      title="LikeBtn"
                    ...
                    >
                      <svg
                        ...
                        viewBox="0 0 24 24"
                        color="#fff"
                        class="likeBtn w-[15px] md:w-[20px]"
                      >
                        <path
                    ...
                    >
                      <svg
                        ...
                        viewBox="0 0 24 24"
                        color="#fff"
                        class="dislikeBtn w-[15px] md:w-[20px]"
                      >
                        <path
...
async function main() {
  ...
  if (songsList && imagesList) {
    ...
    sideMenuToggle();
    playButtonToggle();
    await cardFiller(songsNames, songsPaths, songsImages);
