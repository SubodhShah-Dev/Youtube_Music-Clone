    ...
    song.innerHTML = `
      ...
      <div class="iconsContainer hidden w-[25%] justify-center md:justify-around">
        <button
                    ...
                    >
                    <svg fill="black" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20" color="#fff" class="likeBtn">
                    ...
                    <button
                      ...
                      class="rounded-xl p-[7px] transition-all hover:bg-[#393a32]"
                    >
                    <svg fill="black" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20" color="#fff" class="dislikeBtn" >
